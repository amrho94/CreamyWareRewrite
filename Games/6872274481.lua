		...
		Function = function(callback)
			...
			if callback then
				Speed:Clean(runService.PreSimulation:Connect(function(dt)
					...
					local flyEnabled = (Fly and Fly.Enabled) or false
					local infFlyEnabled = (InfiniteFly and InfiniteFly.Enabled) or false
					local longJumpEnabled = (LongJump and LongJump.Enabled) or false
